...
import delimited "H:\Meu Drive\GPP\MDS - Desertos Alimentares\POF_FromTese\DICIONARIOS PROGRAMACAO FINAL\junta_ali.csv"
...
merge m:1 v9001 using "H:\Meu Drive\GPP\MDS - Desertos Alimentares\POF_FromTese\DICIONARIOS PROGRAMACAO FINAL\dicionario_alimentos.dta", nogen

* Unificar o código de local de compra POF (v9004) com o dicionário de classificação CNAE
* Substituir <caminho> pelo local desejado para salvar o arquivo
merge m:1 v9004 using "H:\Meu Drive\GPP\MDS - Desertos Alimentares\POF_FromTese\DICIONARIOS PROGRAMACAO FINAL\dicionario_locais.dta", nogen

* Salvar a base de alimentação com os dicionários
* Substituir <caminho> pelo local desejado para salvar o arquivo
save "H:\Meu Drive\GPP\MDS - Desertos Alimentares\POF_FromTese\DICIONARIOS PROGRAMACAO FINAL\pof_compras.dta", replace


clear all
* Substituir <caminho> pelo local desejado para salvar o arquivo
use "H:\Meu Drive\GPP\MDS - Desertos Alimentares\POF_FromTese\DICIONARIOS PROGRAMACAO FINAL\pof_compras.dta"
...
save "H:\Meu Drive\GPP\MDS - Desertos Alimentares\POF_FromTese\DICIONARIOS PROGRAMACAO FINAL\pof_compras_morador", replace
...
clear all
cd "H:\Meu Drive\GPP\MDS - Desertos Alimentares\POF_FromTese\DICIONARIOS PROGRAMACAO FINAL\"
use morador_uc.dta
tostring uf estrato_pof tipo_situacao_reg cod_upa num_dom num_uc, replace
gen key_morador=uf+estrato_pof+tipo_situacao_reg+cod_upa+num_dom+num_uc
...
clear
use "H:\Meu Drive\GPP\MDS - Desertos Alimentares\POF_FromTese\DICIONARIOS PROGRAMACAO FINAL\pof_compras_morador.dta"
